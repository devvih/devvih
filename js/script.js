...
// Troca de tempo de animação
const tempoAnimacao = document.querySelectorAll('[data-anime]')

console.log(tempoAnimacao)

function ajustarTempoAnimacao() {
  if(window.innerWidth < 1200) {
    tempoAnimacao.forEach(tempo => tempo.setAttribute('data-anime', '200'))
  }
}

window.addEventListener('rezise', ajustarTempoAnimacao)
ajustarTempoAnimacao()